        ...
        <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 md:gap-6">
          {hotelData.services.map((service) => {
            ...
            return (
              <div
                key={service.id}
                className="card-lift text-center p-3 sm:p-4 md:p-7 rounded-sm"
                style={{
              ...
              >
                <div
                  className="w-10 h-10 sm:w-12 sm:h-12 md:w-14 md:h-14 flex items-center justify-center mx-auto mb-2 sm:mb-3 md:mb-4"
