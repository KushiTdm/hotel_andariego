...
export function RoomCard({ room }: RoomCardProps) {
  return (
    <Link href={`/chambres/${room.slug}`} className="block">
      <div
      ...
      >
        ...
        <div className="p-6">
          ...
          {/* CTA */}
          <div
            className="w-full py-3 font-semibold tracking-wide transition-all duration-300 hover:opacity-90 text-sm text-center"
            style={{
